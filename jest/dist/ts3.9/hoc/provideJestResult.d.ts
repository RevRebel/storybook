...
declare const provideTests: (Component: ComponentType<InjectedProps>) => {
    new (props: HocProps | Readonly<HocProps>): {
        ...
        render(): JSX.Element;
        context: any;
        setState<K extends "storyName" | "kind" | "tests">(state: HocState | ((prevState: Readonly<HocState>, props: Readonly<HocProps>) => HocState | Pick<HocState, K>) | Pick<HocState, K>, callback?: () => void): void;
